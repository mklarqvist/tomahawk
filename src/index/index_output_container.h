#ifndef INDEX_INDEX_OUTPUT_CONTAINER_H_
#define INDEX_INDEX_OUTPUT_CONTAINER_H_
...
#include "index_output_entry.h"

namespace Tomahawk{
namespace Totempole{

/**<
 * STL-like container for Tomahawk index output entries
 */
class IndexOutputContainer{
private:
	typedef IndexOutputContainer  self_type;
	typedef IndexOutputEntry      value_type;
...
public:
    ...
    IndexOutputContainer(const size_t n_capacity_) :
    	n_entries_(0),
	...
	IndexOutputContainer(const char* const data_buffer, const U32 l_data) :
	...
	~IndexOutputContainer(){
		for(size_type i = 0; i < this->size(); ++i)
			((this->entries_ + i)->~IndexOutputEntry)();
...
#endif /* INDEX_INDEX_OUTPUT_CONTAINER_H_ */
