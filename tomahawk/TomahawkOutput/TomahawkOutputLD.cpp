...
TomahawkOutputLD::TomahawkOutputLD() :
	controller(0),
	R2(0),
	D(0),
	Dprime(0),
...
void TomahawkOutputLD::operator=(const TomahawkOutputLD& other){
	this->R2 = other.R2;
	this->D = other.D;
...
void TomahawkOutputLD::printUnphasedCounts(void) const{
...
void TomahawkOutputLD::printPhasedCounts(void) const{
