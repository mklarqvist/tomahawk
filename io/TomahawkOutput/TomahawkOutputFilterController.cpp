...
TomahawkOutputFilterController::TomahawkOutputFilterController() :
	...
	filteredCount(0),
	keepCount(0),
	minP1(std::numeric_limits<U32>::max()),
	minP2(std::numeric_limits<U32>::max()),
	minQ1(std::numeric_limits<U32>::max()),
	minQ2(std::numeric_limits<U32>::max()),
	minMinorAlleles(0),
	maxMinorAlleles(std::numeric_limits<U32>::max()),
	minD(-100), maxD(100),
